    ...
    async def v1_get_job(
        ...
        wait: str | None = Query(
            ...
            description=(
                ...
                "Omit to return immediately (legacy behaviour)."
            ),
            examples=["30s"],
        ),
    ) -> JobView:
        ...
        ``read`` scope, ``JobView`` response, tenant-scoping (404 on
        cross-tenant access, never 403), and ``wait`` long-poll semantics."""
