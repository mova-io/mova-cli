...
from movate.cli.graph_dash_cmd import graph_app  # noqa: E402
...
# `graph` hosts the knowledge-graph viewers (bake-off): `serve-dash` is the
# Dash + dash-cytoscape option. Heavy viz deps are gated behind the opt-in
# `graph-dash` extra; the command prints an install hint if it's absent.
