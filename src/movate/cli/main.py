...
from movate.cli.graph import graph_app  # noqa: E402
...
# `graph serve` launches the local read-only knowledge-graph viewer (sigma.js).
# Lives next to `kb`/`knowledge` since it visualizes the same KB-derived graph.
