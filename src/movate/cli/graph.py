...
graph_app = typer.Typer(
    name="graph",
    help=(
        "Local reference viewer for the knowledge graph (sigma.js + "
        "graphology). Read-only; proxies the deployed runtime's graph "
        "query API with the bearer kept server-side."
    ),
