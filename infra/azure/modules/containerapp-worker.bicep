      ...
      containers: [
        {
          ...
          env: concat([
            ...
            // _resolve_temporal_connection (ADR 054 D5) so a Temporal worker /
            // backend can reach the durable engine. Omitted when empty →
            // runtime:temporal fails loud (ADR 055 D6). No TLS inside the CAE
            // boundary (D5).
            {
              name: 'TEMPORAL_HOST'
              value: temporalHost
